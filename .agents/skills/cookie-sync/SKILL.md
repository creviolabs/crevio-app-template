...
```bash
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --domains google.com,github.com
```
...
```bash
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --context ctx_abc123
```
...
```bash
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --stealth
```
...
```bash
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --proxy "San Francisco,CA,US"
```
...
```bash
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --domains github.com,google.com --stealth --proxy "San Francisco,CA,US"
```
...
node .agents/skills/cookie-sync/scripts/cookie-sync.mjs --domains x.com,twitter.com
